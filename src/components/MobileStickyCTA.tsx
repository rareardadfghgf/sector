...
export function MobileStickyCTA() {
  return (
    <motion.div 
      ...
      className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-white/95 backdrop-blur-md border-t border-gray-100 shadow-[0_-4px_20px_-5px_rgba(0,0,0,0.1)] md:hidden flex gap-3 pb-[max(1rem,env(safe-area-inset-bottom))]"
    >
      <a 
